...
This page is a rendering fixture for `zeropress.plain`. Use it to check typography, spacing, source Markdown links, edit links, code highlighting, tables, task lists, alerts, Mermaid progressive enhancement, and safe raw HTML media.
...
Internal Markdown links are source-relative. For example, [the preview index](../index.md) links to another source Markdown file and is rewritten during build.
...
Headings become anchorable sections when JavaScript is available. The page remains readable without JavaScript.
...
Mermaid fences remain readable source without JavaScript. Plain progressively enhances them into diagrams when JavaScript is available.
